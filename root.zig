...
pub const SetServicePropertiesOptions = options.SetServicePropertiesOptions;
pub const GetServicePropertiesOptions = options.GetServicePropertiesOptions;
pub const GetStatisticsOptions = options.GetStatisticsOptions;
pub const SetServicePropertiesResponse = responses.SdkResponse(protocol_client.SetServicePropertiesResponse);
pub const GetServicePropertiesResponse = responses.SdkResponse(protocol_client.GetServicePropertiesResponse);
pub const GetStatisticsResponse = responses.SdkResponse(protocol_client.GetStatisticsResponse);
pub const ServiceProperties = service_models.ServiceProperties;
pub const Logging = service_models.Logging;
pub const Metrics = service_models.Metrics;
pub const RetentionPolicy = service_models.RetentionPolicy;
pub const CorsRule = service_models.CorsRule;
pub const ServiceStatistics = service_models.ServiceStatistics;
pub const GeoReplication = service_models.GeoReplication;
pub const GeoReplicationStatus = service_models.GeoReplicationStatus;
pub const LastSyncTime = service_models.LastSyncTime;
